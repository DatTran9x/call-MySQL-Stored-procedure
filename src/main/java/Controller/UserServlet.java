...
public class UserServlet extends HttpServlet {
        ...
        try {
            switch (action) {
                ...
                case "sort":
                    ...
                    break;
                case "findByCountry":
                    findByCountryForm(request, response);
                    break;
                case "permision":
    ...
    private void findByCountryForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
